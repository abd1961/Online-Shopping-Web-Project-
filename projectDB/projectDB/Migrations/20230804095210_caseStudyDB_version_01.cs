...
{
    public partial class caseStudyDB_version_01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavOrderItems", x => x.FavId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_FavOrderItems_Users_UserId",
                        column: x => x.UserId,
